...
class _KenBurnsState extends State<KenViews> with TickerProviderStateMixin {
  bool _running = false;
  ...
  @override
  void didUpdateWidget(KenViews oldWidget) {
